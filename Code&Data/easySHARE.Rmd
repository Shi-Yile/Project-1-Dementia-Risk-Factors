...
w5_.iamb <- iamb(subset(w5_, select = -c(id, country)), 
                   blacklist = bl, test = "mi")
graphviz.plot(w5_.iamb)
```
```{r}
ci.test("social", "depression", c("physical", "chronic", "smoking", "female"), 
        data = subset(w5_, select = -c(id, country)), test = "mi")
...
w5_high.iamb <- iamb(subset(w5_high, select = -c(id, country)), 
                   blacklist = bl, test = "mi")
graphviz.plot(w5_high.iamb)
```
```{r}
ci.test("cogscore", "social", c("age", "education", "depression", "female"), 
        data = subset(w5_, select = -c(id, country)), test = "mi")
```

```{r}
# using complete data in low income country in wave 5
w5_low.iamb <- iamb(subset(w5_low, select = -c(id, country)), 
                   blacklist = bl, test = "mi")
...
```
```{r}
ci.test("cogscore", "income", c("age", "education"), 
