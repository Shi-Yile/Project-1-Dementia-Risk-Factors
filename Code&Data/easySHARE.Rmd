...
# modify some unreasonable arrows
w5_.iamb.mod <- drop.arc(w5_.iamb.mod, from = "drinking", to = "finance")
...
ci.test("obesity", "depression", 
        c("female", "chronic", "finance", "social"),
        data = w5_[rf_score], test = "mi")
...
# trends of cognitive score over age in different gender and country groups
# in new BN with updated distribution of cognitive score
# Post-secondary education, Low depression
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 1, 5, 1, 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Male, Low aGDP (P-Secondary Education, Low Depression)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 1, 5, 1, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Male, High aGDP (P-Secondary Education, Low Depression)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 2, 5, 1, 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Female, Low aGDP (P-Secondary Education, Low Depression)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 2, 5, 1, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Female, High aGDP (P-Secondary Education, Low Depression)")
...
# trends of cognitive score over age in different gender and country groups
# in new BN with updated distribution of cognitive score
# Post-secondary education, High depression
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 1, 5, 3, 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Male, Low aGDP (P-Secondary Education, High Depression)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 1, 5, 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Male, High aGDP (P-Secondary Education, High Depression)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 2, 5, 3, 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Female, Low aGDP (P-Secondary Education, High Depression)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(a.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, , 2, 5, 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(a.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  theme(plot.title = element_text(size = 12)) + 
  labs(x = "Age", y = "Conditional probability", color = "Cognitive score", 
       title = "Female, High aGDP (P-Secondary Education, High Depression)")

grid.arrange(p1, p2, p3, p4, ncol = 2)
```

```{r, fig.width = 10}
# trends of cognitive score over education in different gender and country groups
# in new BN with updated distribution of cognitive score
# 60-64, Low depression)
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, , 1, 1]),
                                     ncol = 1),
  ...
  labs(x = "Education", y = "Conditional probability", 
       ...
       title = "Male, Low aGDP (60-64, Low Depression)")
p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, , 1, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (60-64, Low Depression)")
p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, , 1, 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (60-64, Low Depression)")
p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, , 1, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (60-64, Low Depression)")
...
# trends of cognitive score over education in different gender and country
# in new BN with updated distribution of cognitive score
# 60-64, High depression
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, , 3, 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, Low aGDP (60-64, High Depression)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, , 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (60-64, High Depression)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, , 3, 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (60-64, High Depression)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, , 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (60-64, High Depression)")
...
# trends of cognitive score over education in different gender and country groups
# in new BN with updated distribution of cognitive score
# 65-69, High depression
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 1, , 3, 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, Low aGDP (65-59, High Depression)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 1, , 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (65-69, High Depression)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 2, , 3, 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (65-69, High Depression)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(e.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 2, , 3, 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(e.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Education", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (65-59, High Depression)")
...
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, Low aGDP (60-64, No Education)")
...
p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (60-64, No Education)")
...
p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (60-64, No Education)")
...
p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (60-64, No Education)")
...
# trends of cognitive score over depression in different gender and country 
# in new BN with updated distribution of cognitive score
# 60-64, Post-secondary education
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, 5, , 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, Low aGDP (60-64, Post-Secondary Education)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 1, 5, , 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (60-64, Post-Secondary Education)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, 5, , 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (60-64, Post-Secondary Education)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 3, 2, 5, , 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (60-64, Post-Secondary Education)")
...
# trends of cognitive score over depression in different gender and country 
# in new BN with updated distribution of cognitive score
# 65-59, Post-secondary education
p1 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 1, 5, , 1]),
                                     ncol = 1),
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, Low aGDP (65-69, Post-Secondary Education)")

p2 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 1, 5, , 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Male, High aGDP (65-69, Post-Secondary Education)")

p3 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 2, 5, , 1]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, Low aGDP (65-69, Post-Secondary Education)")

p4 <- ggplot(mapping = aes(x = rep(seq(1 : length(d.lv)), 3),
                          y = matrix(t(bn.bayes2$cogscore$prob[, 4, 2, 5, , 2]),
                                     ncol = 1), 
                          color = rep(cs.lv, each = length(d.lv)))) + 
  geom_point() +
  geom_line() +
  ...
  labs(x = "Depression", y = "Conditional probability", 
       color = "Cognitive score", 
       title = "Female, High aGDP (65-69, Post-Secondary Education)")
